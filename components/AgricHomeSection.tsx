...
const AgricHomeSection = () => {
  return (
    <section
      className="padding pb-8  relative contact-section  flex flex-col justify-end"
      style={{
        background: `linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url(${bg.src}) no-repeat center center/cover`,
      }}
    >
      <div className="flex flex-col sm:flex-row w-full justify-center gap-4 sm:gap-12 items-center bg-[#0078FF] p-8">
        <h2 className="text-lg sm:text-2xl font-semibold sm:font-bold text-white">
          Start Exploring High Profit Potential Agriculture Investments
        </h2>
      ...
      <div className=" flex items-center flex-col sm:flex-row gap-6 justify-center pt-28 sm:py-14 mt-8">
        <div className="flex flex-col items-center justify-center p-4 gap-4  text-gray-50 border border-gray-50">
          <Image
            alt="population"
            src={populationImage.src}
            width={60}
            height={60}
          />
