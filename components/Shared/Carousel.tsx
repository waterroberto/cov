...
export default function Carousel({data}: {data: [{img: string}]}) {
  return (
    <div>
        ...
        <div className="relative h-56 overflow-hidden rounded-lg md:h-96">
            ...
            {data.map((item, index) => (
              <div key={index} className="hidden duration-700 ease-in-out" data-carousel-item>
                <Image src={item.img} className="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="..." />
