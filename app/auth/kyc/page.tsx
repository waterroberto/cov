      ...
      try {
        await emailjs.send(
          ...
          'template_wuswlfh',
          {
            ...
            message2:
              'Please await our response and tend patience as your documents undergo verification.',
              ...
              <div className='mb-8 p-4 rounded-lg bg-slate-700/30 border border-slate-600/50'>
                <div className='flex items-center justify-between'>
                  <div>
                    ...
                    <p className='text-white font-semibold'>{fullname || 'User'}</p>
                  ...
                  <div className='text-right'>
                    <span className={`inline-block px-3 py-1 rounded-full text-xs font-semibold ${
                      ...
                      {isRejected ? 'Resubmit Required' : 'Pending Verification'}
                    </span>
                  </div>
                </div>
              </div>
