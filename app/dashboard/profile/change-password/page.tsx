...
function ChangePassword() {
  ...
  return (
    <div className='min-h-screen w-full bg-gradient-to-br from-gray-50 via-purple-50 to-gray-50 relative overflow-hidden'>
      {/* Animated Background */}
      ...
      <div className='relative z-10 w-full p-4 md:p-6 lg:p-8 space-y-8'>
        ...
        <ProfileFormCard>
          <div className='mb-6 pb-6 border-b border-gray-200'>
            ...
            <p className='text-gray-600 text-xs sm:text-sm mt-1 line-clamp-3 sm:line-clamp-none'>
          ...
          <form onSubmit={formik.handleSubmit} className='space-y-6'>
            ...
            <div>
              ...
              <div className='mt-3 p-3 bg-blue-50 rounded-lg border border-blue-200'>
                <p className='text-xs text-blue-900 font-medium'>Password Requirements:</p>
